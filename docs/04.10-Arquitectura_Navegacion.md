...
> **Estado (2026-07-08):** la migración hacia esta estructura de navegación (Ciclo → Carrera → Período → Oferta Académica) ya se completó en el refactor a Bounded Contexts DDD — ver `docs/02.00-Modelo_Datos.md` para el modelo vigente.
